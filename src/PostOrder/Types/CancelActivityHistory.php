...
/**
 *
 * @property \TheCodeBunny\eBayApi\PostOrder\Types\DateTime $actionDate
 * @property string $activityParty
 * @property \TheCodeBunny\eBayApi\PostOrder\Enums\CancelActivityTypeEnum $activityType
 * @property string $cancelStateFrom
 * @property string $cancelStateTo
 * @property string $cancelStatetateTo
 */
class CancelActivityHistory extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
