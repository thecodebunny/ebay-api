 ...
 * @property \TheCodeBunny\eBayApi\PostOrder\Types\Text $sellerComments
 * @property boolean $shippedWithTracking
 * @property string $shippingCarrierName
 * @property \TheCodeBunny\eBayApi\PostOrder\Types\DateTime $shippingDate
 * @property string $trackingNumber
 */
class ShipmentInfoRequest extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
