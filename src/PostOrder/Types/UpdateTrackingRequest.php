...
/**
 *
 * @property \TheCodeBunny\eBayApi\PostOrder\Enums\ShippingCarrierEnum $newCarrierEnum
 * @property string $newCarrierName
 * @property string $newTrackingNumber
 * @property \TheCodeBunny\eBayApi\PostOrder\Enums\ShippingCarrierEnum $usedCarrierEnum
 * @property string $usedCarrierName
 * @property string $usedTrackingNumber
 */
class UpdateTrackingRequest extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
