 ...
 */
class PostOrderBaseService extends \TheCodeBunny\eBayApi\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\PostOrder\Services\PostOrderService::API_VERSION,
                'required' => true
            ],
            'authToken' => [
                'valid' => ['string'],
