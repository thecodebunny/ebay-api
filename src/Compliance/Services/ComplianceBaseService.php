 ...
 */
class ComplianceBaseService extends \TheCodeBunny\eBayApi\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\Compliance\Services\ComplianceService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
