 ...
 * @property \TheCodeBunny\eBayApi\Browse\Enums\RefundMethodEnum $refundMethod
 * @property string $restockingFeePercentage
 * @property string $returnInstructions
 * @property \TheCodeBunny\eBayApi\Browse\Enums\ReturnMethodEnum $returnMethod
 * @property \TheCodeBunny\eBayApi\Browse\Types\TimeDuration $returnPeriod
 * @property boolean $returnsAccepted
 * @property \TheCodeBunny\eBayApi\Browse\Enums\ReturnShippingCostPayerEnum $returnShippingCostPayer
 */
class ItemReturnTerms extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'returnPeriod' => [
            'type' => 'TheCodeBunny\eBayApi\Browse\Types\TimeDuration',
            'repeatable' => false,
            'attribute' => false,
