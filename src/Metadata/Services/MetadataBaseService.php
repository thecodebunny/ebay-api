 ...
 */
class MetadataBaseService extends \TheCodeBunny\eBayApi\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\Metadata\Services\MetadataService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
