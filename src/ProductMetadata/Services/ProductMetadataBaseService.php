 ...
 */
class ProductMetadataBaseService extends \TheCodeBunny\eBayApi\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\ProductMetadata\Services\ProductMetadataService::API_VERSION
            ],
            'globalId' => [
                'valid' => ['string']
            ]
