 ...
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\CountryCodeType $PhoneCountryCode
 * @property string $PhoneCountryPrefix
 * @property string $PhoneAreaOrCityCode
 * @property string $PhoneLocalNumber
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\CountryCodeType $Phone2CountryCode
 * @property string $Phone2CountryPrefix
 * @property string $Phone2AreaOrCityCode
 * @property string $Phone2LocalNumber
 * @property string $PostalCode
 * @property string $AddressID
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\AddressOwnerCodeType $AddressOwner
 ...
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\AddressUsageCodeType $AddressUsage
 * @property string $ReferenceID
 * @property \TheCodeBunny\eBayApi\MerchantData\Types\AddressAttributeType[] $AddressAttribute
 */
class AddressType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'AddressAttribute' => [
            'type' => 'TheCodeBunny\eBayApi\MerchantData\Types\AddressAttributeType',
            'repeatable' => true,
            'attribute' => false,
