 ...
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\PickupStatusCodeType $PickupStatus
 * @property string $MerchantPickupCode
 * @property \DateTime $PickupFulfillmentTime
 * @property string $PickupLocationUUID
 */
class PickupMethodSelectedType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
