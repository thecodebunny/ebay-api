 ...
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\DaysCodeType $Hours1Days
 * @property boolean $Hours1AnyTime
 * @property string $Hours1From
 * @property string $Hours1To
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\DaysCodeType $Hours2Days
 * @property boolean $Hours2AnyTime
 * @property string $Hours2From
 * @property string $Hours2To
 */
class ContactHoursDetailsType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
