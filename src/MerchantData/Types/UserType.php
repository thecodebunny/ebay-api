 ...
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property boolean $IDVerified
 * @property boolean $eBayGoodStanding
 * @property boolean $NewUser
 * @property \TheCodeBunny\eBayApi\MerchantData\Types\AddressType $RegistrationAddress
 * @property \DateTime $RegistrationDate
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\SiteCodeType $Site
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\UserStatusCodeType $Status
 * @property string $UserID
 * @property boolean $UserIDChanged
 * @property \DateTime $UserIDLastChanged
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\VATStatusCodeType $VATStatus
 * @property \TheCodeBunny\eBayApi\MerchantData\Types\BuyerType $BuyerInfo
 * @property \TheCodeBunny\eBayApi\MerchantData\Types\SellerType $SellerInfo
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\BusinessRoleType $BusinessRole
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\PayPalAccountLevelCodeType $PayPalAccountLevel
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\PayPalAccountTypeCodeType $PayPalAccountType
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\PayPalAccountStatusCodeType $PayPalAccountStatus
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\EBaySubscriptionTypeCodeType[] $UserSubscription
 ...
 * @property \TheCodeBunny\eBayApi\MerchantData\Types\BiddingSummaryType $BiddingSummary
 ...
 */
class UserType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BuyerInfo' => [
            'type' => 'TheCodeBunny\eBayApi\MerchantData\Types\BuyerType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BuyerInfo'
        ],
        'SellerInfo' => [
            'type' => 'TheCodeBunny\eBayApi\MerchantData\Types\SellerType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BiddingSummary' => [
            'type' => 'TheCodeBunny\eBayApi\MerchantData\Types\BiddingSummaryType',
            'repeatable' => false,
            'attribute' => false,
