 ...
 * @property string $UPC
 * @property string $EAN
 * @property \TheCodeBunny\eBayApi\MerchantData\Types\BrandMPNType $BrandMPN
 * @property \TheCodeBunny\eBayApi\MerchantData\Types\TicketListingDetailsType $TicketListingDetails
 * @property boolean $UseFirstProduct
 * @property boolean $IncludeeBayProductDetails
 */
class ProductListingDetailsType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BrandMPN' => [
            'type' => 'TheCodeBunny\eBayApi\MerchantData\Types\BrandMPNType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BrandMPN'
        ],
        'TicketListingDetails' => [
            'type' => 'TheCodeBunny\eBayApi\MerchantData\Types\TicketListingDetailsType',
            'repeatable' => false,
            'attribute' => false,
