 ...
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\CharityAffiliationTypeCodeType $AffiliationType
 * @property \DateTime $LastUsedTime
 */
class CharityAffiliationDetailType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
