 ...
 * @property \TheCodeBunny\eBayApi\MerchantData\Enums\InvocationStatusType $Status
 * @property string $InvocationTrackingID
 */
class DuplicateInvocationDetailsType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
