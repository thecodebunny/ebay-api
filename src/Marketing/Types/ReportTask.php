 ...
 * @property \TheCodeBunny\eBayApi\Marketing\Types\Dimension[] $dimensions
 * @property \TheCodeBunny\eBayApi\Marketing\Types\InventoryReference[] $inventoryReferences
 * @property string[] $listingIds
 * @property \TheCodeBunny\eBayApi\Marketing\Types\Bas:MarketplaceIdEnum $marketplaceId
 * @property string[] $metricKeys
 * @property string $reportExpirationDate
 * @property \TheCodeBunny\eBayApi\Marketing\Enums\ReportFormatEnum $reportFormat
 ...
 * @property \TheCodeBunny\eBayApi\Marketing\Enums\TaskStatusEnum $reportTaskStatus
 * @property string $reportTaskStatusMessage
 * @property \TheCodeBunny\eBayApi\Marketing\Enums\ReportTypeEnum $reportType
 */
class ReportTask extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'dimensions' => [
            'type' => 'TheCodeBunny\eBayApi\Marketing\Types\Dimension',
            'repeatable' => true,
            'attribute' => false,
            'elementName' => 'dimensions'
        ],
        'inventoryReferences' => [
            'type' => 'TheCodeBunny\eBayApi\Marketing\Types\InventoryReference',
            'repeatable' => true,
            'attribute' => false,
        ...
        'marketplaceId' => [
            'type' => 'TheCodeBunny\eBayApi\Marketing\Types\Bas:MarketplaceIdEnum',
            'repeatable' => false,
            'attribute' => false,
