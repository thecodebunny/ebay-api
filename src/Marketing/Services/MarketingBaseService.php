 ...
 */
class MarketingBaseService extends \TheCodeBunny\eBayApi\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\Marketing\Services\MarketingService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
