<?php
namespace TheCodeBunny\eBayApi\Services;
...
use TheCodeBunny\eBayApi\Parser\XmlParser;
...
abstract class BaseService
{
     ...
     */
    protected function callOperationAsync($name, \TheCodeBunny\eBayApi\Types\BaseType $request, $responseClass)
    {
        $url = $this->getUrl();
     ...
     */
    protected function buildRequestBody(\TheCodeBunny\eBayApi\Types\BaseType $request)
    {
     ...
     */
    private function buildXopDocument(\TheCodeBunny\eBayApi\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s%s%s',
     ...
     */
    protected function buildMultipartFormDataXMLPayload(\TheCodeBunny\eBayApi\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s',
            '--boundary'.self::CRLF,
