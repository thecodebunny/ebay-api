 ...
 */
class MerchandisingBaseService extends \TheCodeBunny\eBayApi\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\Merchandising\Services\MerchandisingService::API_VERSION
            ],
            'globalId' => [
                'valid' => ['string']
            ]
