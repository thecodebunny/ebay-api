 ...
 */
class FulfillmentBaseService extends \TheCodeBunny\eBayApi\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\Fulfillment\Services\FulfillmentService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
