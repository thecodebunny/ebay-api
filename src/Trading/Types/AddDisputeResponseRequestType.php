 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\DisputeActivityCodeType $DisputeActivity
 * @property string $ShippingCarrierUsed
 * @property string $ShipmentTrackNumber
 * @property \DateTime $ShippingTime
 */
class AddDisputeResponseRequestType extends \TheCodeBunny\eBayApi\Trading\Types\AbstractRequestType
{
    /**
