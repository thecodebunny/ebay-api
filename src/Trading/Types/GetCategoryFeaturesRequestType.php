 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\FeatureIDCodeType[] $FeatureID
 * @property boolean $AllFeaturesForCategory
 */
class GetCategoryFeaturesRequestType extends \TheCodeBunny\eBayApi\Trading\Types\AbstractRequestType
{
    /**
