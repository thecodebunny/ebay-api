 ...
 * @property \TheCodeBunny\eBayApi\Trading\Types\AmountType $Price
 * @property \TheCodeBunny\eBayApi\Trading\Enums\BestOfferStatusCodeType $Status
 * @property integer $Quantity
 * @property string $BuyerMessage
 * @property string $SellerMessage
 * @property \TheCodeBunny\eBayApi\Trading\Enums\BestOfferTypeCodeType $BestOfferCodeType
 * @property string $CallStatus
 */
class BestOfferType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
