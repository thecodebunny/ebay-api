 ...
 * @property \TheCodeBunny\eBayApi\Trading\Types\AmountType $TotalWinningCost
 * @property integer $WonCount
 * @property \TheCodeBunny\eBayApi\Trading\Types\AmountType $TotalWonCost
 * @property integer $WonDurationInDays
 * @property integer $BestOfferCount
 */
class BuyingSummaryType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
