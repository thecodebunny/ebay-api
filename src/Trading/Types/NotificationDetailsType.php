 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\NotificationEventTypeCodeType $Type
 * @property integer $Retries
 * @property \TheCodeBunny\eBayApi\Trading\Enums\NotificationEventStateCodeType $DeliveryStatus
 * @property \DateTime $NextRetryTime
 * @property \DateTime $DeliveryTime
 * @property string $ErrorMessage
 * @property string $DeliveryURLName
 */
class NotificationDetailsType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
