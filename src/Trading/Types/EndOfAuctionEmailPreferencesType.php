 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\EndOfAuctionLogoTypeCodeType $LogoType
 * @property boolean $EmailCustomized
 * @property boolean $TextCustomized
 * @property boolean $LogoCustomized
 */
class EndOfAuctionEmailPreferencesType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
