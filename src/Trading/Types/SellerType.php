 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\CurrencyCodeType $BillingCurrency
 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\SellerLevelCodeType $SellerLevel
 * @property \TheCodeBunny\eBayApi\Trading\Types\AddressType $SellerPaymentAddress
 * @property \TheCodeBunny\eBayApi\Trading\Types\SchedulingInfoType $SchedulingInfo
 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\SiteCodeType $StoreSite
 ...
 * @property \TheCodeBunny\eBayApi\Trading\Types\CharityAffiliationDetailsType $CharityAffiliationDetails
 * @property double $TransactionPercent
 * @property \TheCodeBunny\eBayApi\Trading\Types\IntegratedMerchantCreditCardInfoType $IntegratedMerchantCreditCardInfo
 * @property \TheCodeBunny\eBayApi\Trading\Types\FeatureEligibilityType $FeatureEligibility
 * @property boolean $TopRatedSeller
 * @property \TheCodeBunny\eBayApi\Trading\Types\TopRatedSellerDetailsType $TopRatedSellerDetails
 * @property \TheCodeBunny\eBayApi\Trading\Types\RecoupmentPolicyConsentType $RecoupmentPolicyConsent
...
class SellerType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'SchedulingInfo' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\SchedulingInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'CharityAffiliationDetails' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\CharityAffiliationDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'IntegratedMerchantCreditCardInfo' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\IntegratedMerchantCreditCardInfoType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'IntegratedMerchantCreditCardInfo'
        ],
        'FeatureEligibility' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\FeatureEligibilityType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'TopRatedSellerDetails' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\TopRatedSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'TopRatedSellerDetails'
        ],
        'RecoupmentPolicyConsent' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\RecoupmentPolicyConsentType',
            'repeatable' => false,
            'attribute' => false,
