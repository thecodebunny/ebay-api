 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\GetAllBiddersModeCodeType $CallMode
 * @property boolean $IncludeBiddingSummary
 */
class GetAllBiddersRequestType extends \TheCodeBunny\eBayApi\Trading\Types\AbstractRequestType
{
    /**
