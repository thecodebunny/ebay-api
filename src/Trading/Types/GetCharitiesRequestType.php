 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\StringMatchCodeType $MatchType
 * @property boolean $Featured
 */
class GetCharitiesRequestType extends \TheCodeBunny\eBayApi\Trading\Types\AbstractRequestType
{
    /**
