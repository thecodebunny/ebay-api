 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\ApplicationDeviceTypeCodeType $ApplicationDeviceType
 * @property string $AffiliateUserID
 */
class AffiliateTrackingDetailsType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
