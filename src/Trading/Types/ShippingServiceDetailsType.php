 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\ShippingServiceCodeType $ShippingServiceCode
 * @property \TheCodeBunny\eBayApi\Trading\Enums\ShippingTypeCodeType[] $ServiceType
 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\ShippingCarrierCodeType[] $ShippingCarrier
 * @property boolean $CODService
 * @property \TheCodeBunny\eBayApi\Trading\Types\AnnouncementMessageType[] $DeprecationDetails
 * @property integer $MappedToShippingServiceID
 * @property string $CostGroupFlat
 * @property \TheCodeBunny\eBayApi\Trading\Types\ShippingServicePackageDetailsType[] $ShippingServicePackageDetails
 * @property boolean $WeightRequired
 * @property string $DetailVersion
 * @property \DateTime $UpdateTime
 * @property string $ShippingCategory
 */
class ShippingServiceDetailsType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'DeprecationDetails' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\AnnouncementMessageType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'ShippingServicePackageDetails' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\ShippingServicePackageDetailsType',
            'repeatable' => true,
            'attribute' => false,
