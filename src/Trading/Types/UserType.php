 ...
 * @property \TheCodeBunny\eBayApi\Trading\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property boolean $IDVerified
 * @property boolean $eBayGoodStanding
 * @property boolean $NewUser
 * @property \TheCodeBunny\eBayApi\Trading\Types\AddressType $RegistrationAddress
 * @property \DateTime $RegistrationDate
 * @property \TheCodeBunny\eBayApi\Trading\Enums\SiteCodeType $Site
 * @property \TheCodeBunny\eBayApi\Trading\Enums\UserStatusCodeType $Status
 * @property string $UserID
 * @property boolean $UserIDChanged
 * @property \DateTime $UserIDLastChanged
 * @property \TheCodeBunny\eBayApi\Trading\Enums\VATStatusCodeType $VATStatus
 * @property \TheCodeBunny\eBayApi\Trading\Types\BuyerType $BuyerInfo
 * @property \TheCodeBunny\eBayApi\Trading\Types\SellerType $SellerInfo
 * @property \TheCodeBunny\eBayApi\Trading\Enums\BusinessRoleType $BusinessRole
 * @property \TheCodeBunny\eBayApi\Trading\Enums\PayPalAccountLevelCodeType $PayPalAccountLevel
 * @property \TheCodeBunny\eBayApi\Trading\Enums\PayPalAccountTypeCodeType $PayPalAccountType
 * @property \TheCodeBunny\eBayApi\Trading\Enums\PayPalAccountStatusCodeType $PayPalAccountStatus
 * @property \TheCodeBunny\eBayApi\Trading\Enums\EBaySubscriptionTypeCodeType[] $UserSubscription
 * @property boolean $eBayWikiReadOnly
 * @property integer $TUVLevel
 * @property string $VATID
 * @property boolean $MotorsDealer
 * @property \TheCodeBunny\eBayApi\Trading\Types\BiddingSummaryType $BiddingSummary
 ...
 * @property \TheCodeBunny\eBayApi\Trading\Types\MembershipDetailsType $Membership
...
class UserType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'BuyerInfo' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\BuyerType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BuyerInfo'
        ],
        'SellerInfo' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\SellerType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BiddingSummary' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\BiddingSummaryType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'Membership' => [
            'type' => 'TheCodeBunny\eBayApi\Trading\Types\MembershipDetailsType',
            'repeatable' => false,
            'attribute' => false,
