 ...
 */
class HalfFindingBaseService extends \TheCodeBunny\eBayApi\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\HalfFinding\Services\HalfFindingService::API_VERSION
            ],
            'globalId' => [
                'valid' => ['string']
            ]
