 ...
 * @property \TheCodeBunny\eBayApi\ResolutionCaseManagement\Types\Address $returnAddress
 * @property string $returnMerchandiseAuthorization
 * @property string $additionalReturnInstructions
 */
class OfferRefundUponReturnRequest extends \TheCodeBunny\eBayApi\ResolutionCaseManagement\Types\BaseRequest
{
    /**
