 ...
 */
class ResolutionCaseManagementBaseService extends \TheCodeBunny\eBayApi\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\ResolutionCaseManagement\Services\ResolutionCaseManagementService::API_VERSION
            ],
            'authToken' => [
                'valid' => ['string'],
                'required' => true
