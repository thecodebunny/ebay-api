 ...
 * @property \TheCodeBunny\eBayApi\ReturnManagement\Types\RefundDetailType $refundDetail
 * @property string $comments
 */
class IssueRefundRequest extends \TheCodeBunny\eBayApi\ReturnManagement\Types\BaseRequest
{
    /**
