...
/**
 *
 * @property \TheCodeBunny\eBayApi\ReturnManagement\Enums\MetadataCodeType $codeName
 * @property string[] $value
 */
class MetaDataCodeResultType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
