...
/**
 *
 * @property \TheCodeBunny\eBayApi\ReturnManagement\Enums\NotificationEventNameType $NotificationEventName
 * @property string $RecipientUserID
 * @property string $ExternalUserData
 * @property string $ReturnId
 * @property \DateTime $CreationDate
 * @property string $OtherPartyId
 * @property \TheCodeBunny\eBayApi\ReturnManagement\Enums\ReturnUserRoleType $OtherPartyRole
