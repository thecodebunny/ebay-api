...
/**
 *
 * @property \TheCodeBunny\eBayApi\Account\Types\ErrorDetailV3[] $errors
 * @property \TheCodeBunny\eBayApi\Account\Types\ErrorDetailV3[] $warnings
 */
class GetFulfillmentPoliciesByMarketplaceRestResponse extends \TheCodeBunny\eBayApi\Account\Types\FulfillmentPolicyResponse
{
    use StatusCodeTrait;
