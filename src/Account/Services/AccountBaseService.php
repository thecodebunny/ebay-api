 ...
 */
class AccountBaseService extends \TheCodeBunny\eBayApi\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\Account\Services\AccountService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
