<?php
namespace TheCodeBunny\eBayApi\OAuth\Services;

use GuzzleHttp\Psr7\Request;
use Psr\Http\Message\ResponseInterface;
use TheCodeBunny\eBayApi as Functions;
use TheCodeBunny\eBayApi\ConfigurationResolver;
use TheCodeBunny\eBayApi\Credentials\CredentialsProvider;
use TheCodeBunny\eBayApi\UriResolver;
...
class OAuthService
{
    ...
    private static $operations = [
        'getUserToken' => [
            ...
            'responseClass' => '\TheCodeBunny\eBayApi\OAuth\Types\GetUserTokenRestResponse',
            'params' => [
            ]
        ],
        'refreshUserToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\TheCodeBunny\eBayApi\OAuth\Types\RefreshUserTokenRestResponse',
            'params' => [
            ]
        ],
        'getAppToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\TheCodeBunny\eBayApi\OAuth\Types\GetAppTokenRestResponse',
            'params' => [
            ]
        ]
    ];
    ...
    /**
     * @var \TheCodeBunny\eBayApi\ConfigurationResolver Resolves configuration options.
     */
    private $resolver;

    /**
     * @var \TheCodeBunny\eBayApi\UriResolver Resolves uri parameters.
     */
    private $uriResolver;
    ...
    public static function getConfigDefinitions()
    {
        return [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \TheCodeBunny\eBayApi\OAuth\Services\OAuthService::API_VERSION,
                'required' => true
            ],
            'profile' => [
                'valid' => ['string'],
                'fn'    => 'TheCodeBunny\eBayApi\applyProfile',
            ],
            'credentials' => [
                'valid'   => ['TheCodeBunny\eBayApi\Credentials\CredentialsInterface', 'array', 'callable'],
                'fn'      => 'TheCodeBunny\eBayApi\applyCredentials',
                'default' => [CredentialsProvider::class, 'defaultProvider']
            ],
            'debug' => [
                'valid'   => ['bool', 'array'],
                'fn'      => 'TheCodeBunny\eBayApi\applyDebug',
                'default' => false
            ],
            'httpHandler' => [
                'valid'   => ['callable'],
                'default' => 'TheCodeBunny\eBayApi\defaultHttpHandler'
            ],
            'httpOptions' => [
                'valid'   => ['array'],
                'default' => [
     ...
     *
     * @return \TheCodeBunny\eBayApi\Credentials\CredentialsInterface
     */
    ...
    /**
     * @param \TheCodeBunny\eBayApi\OAuth\Types\GetUserTokenRestRequest $request
     * @return \TheCodeBunny\eBayApi\OAuth\Types\GetUserTokenRestResponse
     */
    public function getUserToken(\TheCodeBunny\eBayApi\OAuth\Types\GetUserTokenRestRequest $request)
    {
     ...
     */
    public function getUserTokenAsync(\TheCodeBunny\eBayApi\OAuth\Types\GetUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \TheCodeBunny\eBayApi\OAuth\Types\GetUserTokenRestRequest();
        }
    ...
    /**
     * @param \TheCodeBunny\eBayApi\OAuth\Types\RefreshUserTokenRestRequest $request
     * @return \TheCodeBunny\eBayApi\OAuth\Types\RefreshUserTokenRestResponse
     */
    public function refreshUserToken(\TheCodeBunny\eBayApi\OAuth\Types\RefreshUserTokenRestRequest $request)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshUserTokenAsync(\TheCodeBunny\eBayApi\OAuth\Types\refreshUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \TheCodeBunny\eBayApi\OAuth\Types\RefreshUserTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
    ...
    /**
     * @param \TheCodeBunny\eBayApi\OAuth\Types\GetAppTokenRestRequest $request
     * @return \TheCodeBunny\eBayApi\OAuth\Types\GetAppTokenRestResponse
     */
    public function getAppToken(\TheCodeBunny\eBayApi\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppTokenAsync(\TheCodeBunny\eBayApi\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
        if (!$request) {
            $request = new \TheCodeBunny\eBayApi\OAuth\Types\GetAppTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
     ...
     * @param \TheCodeBunny\eBayApi\Types\BaseType $request Request object containing the request information.
     *
     * @return \GuzzleHttp\Promise\PromiseInterface A promise that will be resolved with an object created from the JSON response.
     */
    private function callOperationAsync($name, \TheCodeBunny\eBayApi\Types\BaseType $request = null)
    {
