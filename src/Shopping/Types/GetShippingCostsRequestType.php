 ...
 * @property \TheCodeBunny\eBayApi\Shopping\Enums\CountryCodeType $DestinationCountryCode
 * @property boolean $IncludeDetails
 */
class GetShippingCostsRequestType extends \TheCodeBunny\eBayApi\Shopping\Types\AbstractRequestType
{
    /**
