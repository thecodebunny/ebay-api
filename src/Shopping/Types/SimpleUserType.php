 ...
 * @property \TheCodeBunny\eBayApi\Shopping\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property integer $FeedbackScore
 * @property boolean $UserAnonymized
 * @property boolean $NewUser
 * @property \DateTime $RegistrationDate
 * @property \TheCodeBunny\eBayApi\Shopping\Enums\SiteCodeType $RegistrationSite
 * @property \TheCodeBunny\eBayApi\Shopping\Enums\UserStatusCodeType $Status
 * @property \TheCodeBunny\eBayApi\Shopping\Enums\SellerBusinessCodeType $SellerBusinessType
 ...
 * @property \TheCodeBunny\eBayApi\Shopping\Enums\SellerLevelCodeType $SellerLevel
 * @property boolean $TopRatedSeller
 */
class SimpleUserType extends \TheCodeBunny\eBayApi\Types\BaseType
{
    /**
