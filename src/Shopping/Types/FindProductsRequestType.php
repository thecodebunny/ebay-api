 ...
 * @property \TheCodeBunny\eBayApi\Shopping\Enums\ProductSortCodeType $ProductSort
 * @property \TheCodeBunny\eBayApi\Shopping\Enums\SortOrderCodeType $SortOrder
 * @property integer $MaxEntries
 * @property integer $PageNumber
 * @property string $CategoryID
 * @property boolean $HideDuplicateItems
 */
class FindProductsRequestType extends \TheCodeBunny\eBayApi\Shopping\Types\AbstractRequestType
{
    /**
