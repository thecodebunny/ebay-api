...
use TheCodeBunny\eBayApi\Credentials\Credentials;
use TheCodeBunny\eBayApi\Credentials\CredentialsInterface;
...
function applyCredentials($value, array &$configuration)
{
    if (is_callable($value)) {
        ...
        throw new \InvalidArgumentException(
            ...
            . 'TheCodeBunny\eBayApi\Credentials\CredentialsInterface, an associative '
 ...
 *
 * @return \TheCodeBunny\eBayApi\HttpHandler
 */
...
{
    if (\TheCodeBunny\eBayApi\Sdk::$STRICT_PROPERTY_TYPES) {
        return true;
    }
