<?php
namespace TheCodeBunny\eBayApi\Parser;
...
class XmlParser
{
     ...
     *
     * @return mixed A PHP object derived from TheCodeBunny\eBayApi\Types\BaseType
     */
    ...
    {
        return (
            is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\Base64BinaryType', false) ||
            is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\BooleanType', false) ||
            is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\DecimalType', false) ||
            is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\DoubleType', false) ||
            is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\IntegerType', false) ||
            is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\StringType', false) ||
            is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\TokenType', false) ||
            is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\URIType', false)
        );
    }
    ...
    {
        if (is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\Base64BinaryType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\BooleanType', false)) {
            return strtolower($meta->strData) === 'true';
        } elseif (is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\DecimalType', false)) {
            return is_int(0 + $meta->strData) ? (integer)$meta->strData : (double)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\DoubleType', false)) {
            return (double)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\IntegerType', false)) {
            return (integer)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\StringType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\TokenType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\TheCodeBunny\eBayApi\Types\URIType', false)) {
            return $meta->strData;
        }
