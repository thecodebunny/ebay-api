...
{
    /**
     * @param mixed A PHP object derived from TheCodeBunny\eBayApi\Types\BaseType
    ...
    private static function assignProperties(\TheCodeBunny\eBayApi\Types\BaseType $object, array $properties)
    {
